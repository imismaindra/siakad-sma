...
@section('sidebar-nav')
    ...
    <a href="{{ route('admin.dashboard') }}" class="sidebar-link {{ request()->routeIs('admin.dashboard') ? 'active' : '' }}">
        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2H5a2 2 0 00-2 2v1m0 0l4-4m0 0l4 4m-4-4v10"/></svg>
        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" class="w-4 h-4"><rect x="3" y="3" width="7" height="7" rx="1" stroke-width="2"/><rect x="14" y="3" width="7" height="7" rx="1" stroke-width="2"/><rect x="3" y="14" width="7" height="7" rx="1" stroke-width="2"/><rect x="14" y="14" width="7" height="7" rx="1" stroke-width="2"/></svg>
        Dashboard
    </a>

    <p class="sidebar-section-label">Data Master</p>
    ...
    <a href="{{ route('admin.kelas.index') }}" class="sidebar-link {{ request()->routeIs('admin.kelas*') || request()->routeIs('admin.jurusan*') ? 'active' : '' }}">
    ...
    <a href="{{ route('admin.mata-pelajaran.index') }}" class="sidebar-link {{ request()->routeIs('admin.mata-pelajaran*') ? 'active' : '' }}">
    ...
    <a href="{{ route('admin.nilai.laporan') }}" class="sidebar-link {{ request()->routeIs('admin.nilai*') ? 'active' : '' }}">
    ...
    <a href="{{ route('admin.user.index') }}" class="sidebar-link {{ request()->routeIs('admin.user*') && !request()->routeIs('admin.user.roles*') ? 'active' : '' }}">
